...
function drawLargeTickMarks(options) {
    ...
    for (iTick = 20; iTick < 180; iTick += 16) {
...
function drawNeedle(options) {
    ...
    */
    ...
    var iSpeedAsAngle = convertSpeedToAngle(options),
        ...
        gaugeOptions = options.gaugeOptions,
        innerTickX = gaugeOptions.radius - (Math.cos(iSpeedAsAngleRad) * 16),
        innerTickY = gaugeOptions.radius - (Math.sin(iSpeedAsAngleRad) * 16),
...
function readJsonFile(fileLocation){
    ...
    $.getJSON( fileLocation, function( json ) {
     ...
     console.log( "JSON Data received, name is " + coverageValue);
}
...
function readJsonFilee(fileLocation){
    ...
    $.getJSON( fileLocation, function( json ) {
        ...
        var deneme = json.condition;
    });

}

function drawWithInputValue(fileLocation) {

        var txtSpeed = document.getElementById('txtSpeed');

    if (txtSpeed !== null) {

        readJsonFile(fileLocation);
        iTargetSpeed = coverageValue;
